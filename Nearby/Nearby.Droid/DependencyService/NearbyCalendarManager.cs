...
[assembly: Dependency(typeof(NearbyCalendarManager))]


namespace Nearby.Droid.DependencyService
{
    public class NearbyCalendarManager : IReminderService
    {
        ...
        public void AddEvent(DateTime startTime, DateTime endTime, string title, string location, string message, Action<bool> callback, string id)
        {
            ...
            try
            {
                ...
                uri = Forms.Context.ContentResolver.Insert(CalendarContract.Reminders.ContentUri, reminderValues);
            }
        ...
        public bool EventExists(DateTime startTime, string title, string id)
        {
            ...
            try
            {
                ...
                var cr = Forms.Context.ContentResolver;
            ...
            return false; // SaveTheDate.Helpers.Settings.GetEventId(id) != -1;
        }
