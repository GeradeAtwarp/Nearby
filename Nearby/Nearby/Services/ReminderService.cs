                            ...
                            MessagingService.Current.SendMessage<MessagingServiceQuestion>(MessageKeys.Question, new MessagingServiceQuestion
                                {
                                    ...
                                    Question = "Unable to set reminders as the Calendar permission was not granted. Please go into Settings and turn on Calendars for Nearby.",
                                    Positive = "Settings",
        ...
        static async Task<Calendar> GetOrCreateEvolveCalendarAsync()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        //find first calendar we can add stuff to
                        if(calendar.CanEditEvents && calendar.Name == "Nearby - Events & Places")
                        {
                            Settings.Current.EvolveCalendarId = calendar.ExternalID;
                            return calendar;
                        }
            ...
            evolveCalendar.Color = "#3F51B5";
            evolveCalendar.Name = "Nearby - Events & Places";
